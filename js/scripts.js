    ...
    NioApp.Plugins.carousel = function () {
		...
		if ($carousel.exists()) {
			$carousel.each(function () {
                var $self = $(this);
                var c_item = ($self.data('items')) ? $self.data('items') : 5;
                var c_item_t_l = ($self.data('items-tab-l')) ? $self.data('items-tab-l') : 1;
                var c_item_t_p = ($self.data('items-tab-p')) ? $self.data('items-tab-p') : 1;
                var c_item_m = ($self.data('items-mobile')) ? $self.data('items-mobile') : 1;
                var c_scroll = ($self.data('scroll')) ? $self.data('scroll') : 1;
                var c_delay =($self.data('delay')) ? $self.data('delay') : 0;
                var c_speed =($self.data('speed')) ? $self.data('speed') : 5000;
                ...
                var c_navs = ($self.data('navs')) ? $self.data('navs') : true;
                ...
                if(c_item===1){
                    c_item_t_l = c_item_t_p = c_item_m = 2;
                };
